...
from InstantHub.permission import IsSuperAdmin
from InstantHub.Helper import renderResponse
...
class SignUpAPIView(APIView):
    def post(self, request):
        ...
        if username is None or email is None or password is None:
            return renderResponse(data='Please provide all the fields', message = 'Please provide all the fields', status=status.HTTP_400_BAD_REQUEST)
